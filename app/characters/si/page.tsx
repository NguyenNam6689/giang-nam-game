...
export default function SiCharactersPage() {
  const [characters, setCharacters] = useState<SiCharacter[]>([
    {
      ...
      note1: "Vạn Thế Sư Biểu",
      star2: "Tăng 20% hiệu quả giáo dục",
      star3: "Tăng 25% hiệu quả quản lý",
      star4: "Tăng 30% hiệu quả nghiên cứu",
      construction: "80",
      farming: "85",
      production: "90",
      finance: "95",
      exploration: "70",
      treasureName: "Luận Ngữ",
      treasureImage: "/placeholder.svg?height=60&width=60",
      level50Stats: "HP: 2800, ATK: 160, DEF: 140",
      note2: "Chuyên gia quản lý và giáo dục",
    },
  ])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingCharacter) {
      ...
      const newCharacter: SiCharacter = {
        id: Date.now(),
        name: formData.name || "",
